...
class RouteStatusInfo {
  ...
  final Widget page;
  RouteStatusInfo(this.page, this.routeStatus);
}
...
class HiNavigator extends _RouteJumpListener {
  ...
  void notify(List<MaterialPage> currentPages, List<MaterialPage> prePages) {
    ...
    var current =
        RouteStatusInfo(currentPages.last.child, getStatus(currentPages.last));
    _notify(current);
  }
...
//首页底部tab变化监听
  void onBottomTabChanged(Widget page, int index) {
    _bottomTab = RouteStatusInfo(page, RouteStatus.home);
    _notify(_bottomTab!);
  }
}
